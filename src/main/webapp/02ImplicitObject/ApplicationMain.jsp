...
<!DOCTYPE html>
<html>
<head><meta charset="UTF-8"><title>내장 객체 - application</title></head>
<body> 
	<h2>web.xml에 설정한 내용 읽어오기</h2>
	<!-- web.xml에 <context-param> 으로 설정한 값을 내장객체를 통해
	읽어올 수 있다. -->
	application 내장 객체 : <%= application.getInitParameter("INIT_PARAM") %>
	...
	*/
	...
	public String useImplicitObject(ServletContext app) {
		/* 방법2 : 스크립트렛에서 메서드를 호출할때 application 내장객체를
			매개변수로 전달해서 사용한다. */
