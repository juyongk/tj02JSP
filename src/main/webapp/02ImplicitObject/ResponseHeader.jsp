...
getTime() : 날짜를 1970년부터 지금까지의 시간을 초단위로
	변경하여 반환해준다.
*/
//문자열 형식을 날짜형식으로 변형하기 위해 포맷을 설정한다. 
/*
...
연산이 필요한 경우에는 변환 후 사용해야 한다. */

/*
addDateHeader(헤더명, long타입의 타임스탬프)
	: 응답헤더에 날짜형식을 추가하는 경우 long타입의 타임스탬프로 변환 후
	추가하면 된다. 
...
%>
<html>
<head><meta charset="UTF-8"><title>내장 객체 - response</title></head>
<body>
	<h2>응답 헤더 정보 출력하기</h2>
	<%
	...
	통일한 값 8282가 출력된다. 이것은 getHeader()메서드의 특성으로
	처음 입력한 헤더값만 출력되게 된다. */
	 %>
