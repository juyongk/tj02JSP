...
<!-- 
import 태그
	: 외부의 문서를 현재 문서에 포함시킨다. include 지시어처럼 외부문서를
 ...
 -->
	...
	<!-- 
	var 속성을
		미 사용시 : include 액션태그와 동일하게 현재 위치에 즉시 외부문서를
		포함시킨다.
	...
	경로까지 수정해야하는 경우가 이를 최소화할수 있도록 개발하는것이 좋다.
	...
	<!-- 앞에서 선언한 import태그의 var 속성의 변수를 통해 문서의
	내용을 출력한다. -->
	<h4>다른 문서 삽입하기</h4>
	${ contents }
