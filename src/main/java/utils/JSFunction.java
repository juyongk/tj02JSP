...
public class JSFunction {
	...
	/* 상단 2개의 메서드는 JSP에서 사용하기 위해 정의하였다. JSP에서 out
	  ...
	  정의하였다. 서블릿은 직접 요청을 받으므로 response내장객체를 통해
	  화면출력 용도인 PrintWriter객체를 생성하여 사용한다. */
	
	public static void alterLocation(HttpServletResponse resp ,String msg, String url) {
		try {
			//컨텐츠 타입을 설정
